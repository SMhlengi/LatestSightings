...
namespace LatestSightingsLibrary
{
    public class library
    {
        ...
        private const string SQL_GET_TOP_TINGS = "SELECT top (@tingnumber) a.id as id,a.title as title, a.time as time, b.name FROM tings a INNER JOIN parks b ON a.parkid = b.id WHERE a.animal IS NOT NULL AND a.published = 'published' ORDER BY time DESC";
