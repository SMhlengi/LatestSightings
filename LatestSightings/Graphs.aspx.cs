...
namespace LatestSightings
{
    public partial class Graphs : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<YouTubeVideoAnalytic> days1 = YouTubeVideoAnalytic.GetDays(date.Year, date.Month);
            List<YouTubeVideoAnalytic> days2 = YouTubeVideoAnalytic.GetDays(date.AddMonths(-1).Year, date.AddMonths(-1).Month);
            ...
            List<LatestSightingsLibrary.Video> videos = LatestSightingsLibrary.Video.GetVideosCompact();
            List<YouTubeVideoAnalytics> stats = LatestSightingsLibrary.Video.GetYouTubeVideoAnalytics(year, month);
