...
namespace LatestSightingsService
{
    public class ExHandler
    {
        ...
        private static void LogMessage(string errorText)
        {
            ...
            try
            {
                File.AppendAllText("c:/LatestSightingsService/errors.txt", errorText + Environment.NewLine);
            }
            catch (Exception ex)
            {
        ...
        private static void EmailMessage(string errorText)
        {
            ...
            if (sendEmail)
            {
                try
                {
                    ...
                    message.Subject = "Latest Sightings Service Error";
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("Error details for Latest Sightings Service<br /><br />");
